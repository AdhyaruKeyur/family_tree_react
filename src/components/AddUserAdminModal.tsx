...
export const AddUserAdminModal = ({ open, onOpenChange, onUserAdded }: AddUserAdminModalProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const age = formData.dateOfBirth ? 
      new Date().getFullYear() - new Date(formData.dateOfBirth).getFullYear() : 0;
    ...
    toast({
      ...
      description: `${formData.fullName} has been successfully added to the family tree.`,
    });
